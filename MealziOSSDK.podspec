...
Pod::Spec.new do |spec|
    ...
    spec.source            = { :http => 'https://github.com/miamtech/MealziOSSDKRelease/raw/release/6.0.5-hotfix1/MealziOSSDK.zip' }
    spec.dependency 'MealzCore', '6.0.5-hotfix1'
