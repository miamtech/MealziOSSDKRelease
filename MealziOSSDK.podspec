...
Pod::Spec.new do |spec|
    ...
    spec.source            = { :http => 'https://github.com/miamtech/MealziOSSDKRelease/raw/release/5.10.8-alpha1/MealziOSSDK.zip' }
    spec.dependency 'MealzCore', '~> 5.10.8-alpha1'
